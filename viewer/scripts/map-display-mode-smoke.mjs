...
assert.match(appSource, /setSelectedSectionId\(sectionId\);\s*setMapDisplayMode\("section-focus"\);\s*setOverviewRotationStopped\(true\);/s);
...
assert.match(appSource, /onSelectSection=\{selectSectionForFocus\}/);
